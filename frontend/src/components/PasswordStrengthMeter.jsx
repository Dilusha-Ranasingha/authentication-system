        ...
        <div className='mt-2 space-y-1'>
            {criteria.map((item) => (
                <div key={item.label} className='flex items-center text-xs'>
                    {item.met ? ( <Check className='size-4 text-blue-500 mr-2' />) : (<X className='size-4 text-gray-500 mr-2' />)}             {/* this check mark show the password criteria is met or not and X show the password criteria is not met*/}
